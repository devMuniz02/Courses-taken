...
- Coursera - Introduction to Electronics - Build a Modern Computer from First Principles: From Nand to Tetris (Project-Centered Course) - What is Data Science?

- Coursera Project Network - Detecting COVID-19 with Chest X-Ray using PyTorch - GenAI Summarization with Langchain: Summarize Text Documents
...
1. Clone the repository.
   ...
   ```bash
   git clone https://github.com/devMuniz02/Courses-taken.git
   cd Courses-taken
   ```
